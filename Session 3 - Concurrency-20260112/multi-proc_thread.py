...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="simple thread vs multiproc script", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument("-n", "--number", type=int, help="number of workers",required=True, default=2)
